const contentCTRL = (() => {
    ...
    const heroNews = {
        page_1: {
            box_1: ['Pastor Greg Laurie of Harvest Christian Fellowship', 'Pastor Greg Laurie addressing the congregation'],
            box_2: ['Litle Hattie Collins (right) and family', 'President Donald Trump visits the affected areas in  Tennessee'],
            box_3: ['First lady Melania Trump (L), Susanna Liew (C), and Secretary of state, Mike Pompeo (R)','A photo of Susanna Liew and her family'],
            box_4: ['The church of the Nativity in Bethlehem', 'Tourists outside the church of the Nativity', 'Palestanian Police stand guard Outside the church due to coronavirus outbreak'],
            box_5: ['Trina Carr\'s truck in flames', 'Bible unburnt after truck burns'],
            box_6: ['Assistant football coach Joe Kennedy of Bremerton High School','Coach Joe Kennedy surrounded by his players durning a prayer session'],
            box_7: ['Christians in Nigeria take part in funeral festivities in April 2019','Trump tells Nigeria\'s president church attacks must stop'],
            box_8: ['Pastor Tont Evans and wife Lois Evans','Pastor Tony Evans senior pastor at the Oak Cliff Fellowship Church in Dallas', '“My wife saw a glimpse of heaven” - Pastor Tony Evans'],
            box_9: ['Anthony Mackie and Samuel L. Jackson appear at "The Banker" premiere','Actress Nia Long attends the red carpet premier of "The banker"']
        },
        page_2: {
