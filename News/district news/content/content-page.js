const contentCTRL = (() => {
    ...
    const heroNews = {
        page_1: {
            box_1: ['Ikwerre west district women\'s rally','District supretendent of ikwerre west, Rev John Vitalis', 'Wife of the district supretendent, Rev. Mrs Judith John', 'Ikwerre west district women\'s choir', 'During the prayer session'],
            box_2: ['Cover Photo Of Abasio','Fjoez: Solid Rock (Cover)', 'Ebenezer: Fjoez & The H.R.P.C', 'Cover Photo Of Obimmo', 'Dafdoxa Records', 'Fjoez In Worship'],
            box_3: ['Rev. Anthony Asuquo & Wife Mrs. Evelyn Asuquo','Cutting Of The Birthday Cake', 'Celebrant\'s Birthday cake', 'Group Photograph Of Deacons, Pastors & Deaconesses'],
        },
        page_2: {
